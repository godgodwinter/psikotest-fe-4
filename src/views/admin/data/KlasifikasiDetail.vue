...
const getData = async () => {
  try {
    const response = await Api.get(`siswa/data/klasifikasi/${id}`);
  ...
  <div class="pt-4 px-10 md:flex justify-between" v-if="data">
    <div>
      <span
        ...
        >Detail Klasifikasi Akademis dan Profesi</span
      >
    </div>
    <div class="md:py-0 py-4">
      <BreadCrumb>
        <template v-slot:content>
          Klasifikasi Akademis <BreadCrumbSpace /> Index
        </template>
      </BreadCrumb>
    </div>
  </div>
    ...
    <div class="bg-white shadow rounded-lg px-4 py-2">
      <div class="overflow-x-auto px-4 space-y-10 py-2">
        <div class="space-y-2">
          ...
          <div class="space-y-2 border-b-2 py-2">
            <p class="indent-8 text-gray-700">{{ data.akademis }}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg px-4 py-2">
      <div class="overflow-x-auto px-4 space-y-10 py-2">
        <div class="space-y-2">
          ...
          <div class="space-y-2 border-b-2 py-2">
            <p class="indent-8 text-gray-700">{{ data.profesi }}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg px-4 py-2">
      <div class="overflow-x-auto px-4 space-y-10 py-2">
        <div class="space-y-2">
          ...
          <div class="space-y-2 border-b-2 py-2">
            <p class="indent-8 text-gray-700">{{ data.nilaistandart }}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg px-4 py-2">
      <div class="overflow-x-auto px-4 space-y-10 py-2">
        <div class="space-y-2">
          ...
          <div class="space-y-2 border-b-2 py-2">
            <p class="indent-8 text-gray-700">{{ data.iqstandart }}</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="w-full lg:w-full">
    <div class="bg-white shadow rounded-lg px-4 py-2">
      <div class="overflow-x-auto px-4 space-y-10 py-2">
        <div class="space-y-2">
          <h1 class="text-lg font-bold text-gray-700 py-2 bg-gray-100 shadow">
            Jurusan dan Bidang Studi yang ditekuni
          </h1>

          <div class="space-y-2 border-b-2 py-2">
            <p class="indent-8 text-gray-700">
              {{ data.jurusandanbidangstudi }}
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="bg-white shadow rounded-lg px-4 py-2">
      <div class="overflow-x-auto px-4 space-y-10 py-2">
        <div class="space-y-2">
          ...
          <div class="space-y-2 border-b-2 py-2">
            <p class="indent-8 text-gray-700">{{ data.ket }}</p>
          </div>
        </div>
      </div>
    </div>
